...
- [ ] **P1 HW-004** Run 8-hour playback/transition soak tests and record callback deadline misses, recovery attempts, endpoint-volume invariance, and memory growth. The isolated generated-audio runner and short live qualification pass are complete; the real eight-hour report is still required. See [audio soak qualification](audio/AUDIO-SOAK-QUALIFICATION-2026-07-31.md).
